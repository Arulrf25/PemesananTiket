...
<body>
    <div class="wrapper">
        <div class="logo"> <img src="assets/img/primajasa.jpg" alt="">
        </div>
        <div class="text-center mt-4 "> <b>Pemesanan Tiket</b> </div>
        <div class="text-center "> <b>Bus Primajasa</b> </div>
        ...
        <div class="text-center fs-6"> <a href="" style="color: #ffff">Lupa password?</a> atau <a href="/" style="color: #ffff">Beranda</a> </div>
    </div>
